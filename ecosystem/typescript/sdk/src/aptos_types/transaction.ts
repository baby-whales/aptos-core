...
export class MultiSig {
   ...
   * @param transaction_payload The payload of the multisig transaction. This is optional when executing a multisig transaction
   *  whose payload is already stored on chain.
   */
  constructor(
    public readonly multisig_address: AccountAddress,
    public readonly transaction_payload?: EntryFunction | undefined,
  ) {}
