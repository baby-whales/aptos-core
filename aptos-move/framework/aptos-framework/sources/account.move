module aptos_framework::account {
    ...
    public entry fun rotate_authentication_key(
        ...
        update_originating_address_table(addr, account_resource, new_auth_key);
    }
    ...
    public entry fun rotate_authentication_key_with_rotation_capability(
        ...
        update_originating_address_table(rotation_cap_offerer_address, offerer_account_resource, new_auth_key);
    }
    ...
    fun update_originating_address_table(
